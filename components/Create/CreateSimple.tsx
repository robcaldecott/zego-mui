...
import type { Config, VehiclePayload } from "@/types";
...
export const CreateSimple = ({ fleetId, config }: CreateSimpleProps) => {
    ...
    <Paper variant="outlined">
      ...
      <form
        onSubmit={async (event) => {
          ...
          setSubmitting(true);
          try {
            await http.post(`https://zego.backend/fleets/${fleetId}/vehicles`, {
              json: {
                ...values,
            ...
            // Success
            router.push(`/fleets/${fleetId}/vehicles`);
          } catch (e) {
            setSubmitting(false);
          }
        }}
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={6} sm="auto">
              <Button
                ...
                variant="outlined"
                color="secondary"
                onClick={() => router.push(`/fleets/${fleetId}/vehicles`)}
                sx={{ width: { xs: 1, sm: "auto" } }}
                disabled={submitting}
              >
                <Trans>Cancel</Trans>
